...
var bankInstanceContext = function(driver, params) {
    ...
    context["When we create a " + driver + " databank"] = {
        ...
        'it has an incrBy method': function(bank) {
            assert.isFunction(bank.incrBy);
        },
        'it has a decrBy method': function(bank) {
            assert.isFunction(bank.decrBy);
        },
        ...
        'it has an appendAll method': function(bank) {
            assert.isFunction(bank.appendAll);
        },
        'it has a prependAll method': function(bank) {
            assert.isFunction(bank.prependAll);
        },
        ...
        'it has a remove method': function(bank) {
            assert.isFunction(bank.remove);
        },
        'it has a removeAll method': function(bank) {
            assert.isFunction(bank.removeAll);
        },
        'it has a length method': function(bank) {
            assert.isFunction(bank.length);
        },
        'it has a truncate method': function(bank) {
            assert.isFunction(bank.truncate);
        }
    };
